<html>
    ...
    <title>Tri par immatriculation des véhicules</title>
    <!--Police-->
...
<!-- TABLEAU DES TOUS LES VEHICULES PAR IMMATRICULATION PAR ORDRE ALPHABETIQUE -->
    <table class="table table-bordered table-striped table-condensed table-hover">
        <caption>
            <h2>Liste de tous les véhicules classés par immatriculation</h2>
        </caption>
        <thead>
            <tr>
                <th>Type</th>
